...
The lambda timeout on JSON to Parquet was a solid warning to me that lambdas aren't meant to parse big JSON docs. My implementation of ijson was a temporary fix at best. I have since shifted the JSON parsing to EMR Serverless/PySpark. This is more costly by about $0.01 per day, but this method is going to scale over time as the number of Magic cards continually increases. I also used this opportunity to do away with my intermediate CSV conversion step.
